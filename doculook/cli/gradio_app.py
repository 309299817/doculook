...
from doculook.cli.common import prepare_env, read_fn, aio_do_parse, pdf_suffixes, image_suffixes
from doculook.utils.cli_parser import arg_parse
from doculook.utils.hash_utils import str_sha256
...
def main(ctx,
    ...
    if sglang_engine_enable:
        try:
            ...
            # VLM 已移除，不再支持 sglang-engine
            raise RuntimeError("VLM backend has been removed; use pipeline.")
